...
export default () => {
    ...
    const OnClickSubmitHandler = (data: typeof defaultValues ) => {
        router.post('add-events', {
            ...
            forceFormData: true,
            onSuccess: () => {
                toast.success('New ESports events added!', {
                    position: 'top-right'
                })
            }
        })
        ...
        <Dialog>
            ...
            <DialogPortal>
                <DialogContent>
                    ...
                    <form onSubmit={handleSubmit(OnClickSubmitHandler)} className="space-y-5">
                        <div>
