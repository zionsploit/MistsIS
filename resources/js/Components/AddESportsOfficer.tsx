...
export default () => {
    ...
    const OnClickAddOfficerHandler = (data: typeof defaultValues) => {
        router.post('add-officer', {
        ...
        <Dialog>
            ...
            <DialogPortal>
                <DialogContent>
                    ...
                    <form onSubmit={handleSubmit(OnClickAddOfficerHandler)} className="space-y-5">
                        <div>
